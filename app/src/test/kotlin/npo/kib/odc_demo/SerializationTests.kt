...
import npo.kib.odc_demo.model.serialization.ByteArrayChunkedConverter.toByteArrayFromChunks
import npo.kib.odc_demo.model.serialization.ByteArrayChunkedConverter.toChunksList
import npo.kib.odc_demo.model.serialization.BytesToTypeConverter.deserializeToDataPacket
import npo.kib.odc_demo.model.serialization.BytesToTypeConverter.deserializeToDataPacketType
import npo.kib.odc_demo.model.serialization.BytesToTypeConverter.deserializeToDataPacketVariant
import npo.kib.odc_demo.model.serialization.TypeToBytesConverter.serializeToByteArray
import npo.kib.odc_demo.model.serialization.TypeToBytesConverter.toSerializedDataPacket
import npo.kib.odc_demo.model.serialization.bytesToInt
import npo.kib.odc_demo.model.serialization.serializable.Banknote
import npo.kib.odc_demo.model.serialization.serializable.BanknoteWithBlockchain
import npo.kib.odc_demo.model.serialization.serializable.BanknoteWithProtectedBlock
import npo.kib.odc_demo.model.serialization.serializable.ProtectedBlock
import npo.kib.odc_demo.model.serialization.serializable.data_packet.DataPacketType
import npo.kib.odc_demo.model.serialization.serializable.data_packet.variants.BanknotesList
import npo.kib.odc_demo.model.serialization.serializable.data_packet.variants.DataPacketVariant
import npo.kib.odc_demo.model.serialization.serializable.data_packet.variants.UserInfo
import npo.kib.odc_demo.model.serialization.toBytes
...
//            }
    ...
    fun testChunkedCborSerializeDeserialize() {
        runTest {
            val initial =
                npo.kib.odc_demo.model.serialization.serializable.data_packet.variants.UserInfo(
                    "TestName",
                    "TestWID"
                )
...
//        testObjectSerializationAndDeserialization<Block>(block)
    ...
    fun testBanknotesListSerAndDeser() {
        val mList: MutableList<npo.kib.odc_demo.model.serialization.serializable.BanknoteWithBlockchain> = mutableListOf()
        for (i in (0..999)) {
            mList.add(
                npo.kib.odc_demo.model.serialization.serializable.BanknoteWithBlockchain(
                    banknoteWithProtectedBlock = npo.kib.odc_demo.model.serialization.serializable.BanknoteWithProtectedBlock(
                        banknote = npo.kib.odc_demo.model.serialization.serializable.Banknote(
                            bin = 5550 * i,
                            amount = 1467 * i,
                            code = 9211 * i,
                            bnid = "Jesslyn",
                        ...
                        protectedBlock = npo.kib.odc_demo.model.serialization.serializable.ProtectedBlock(
                            parentSok = null,
        ...
        val bList =
            npo.kib.odc_demo.model.serialization.serializable.data_packet.variants.BanknotesList(
                list = mList.toList()
            )
    ...
    private fun assertSameObjectSerializeDeserialize(dataPacket: npo.kib.odc_demo.model.serialization.serializable.data_packet.variants.DataPacketVariant) = assertEquals(
    ...
    fun testUserInfoDataPacketSerializationAndDeserialization() {
        ...
        val packet = npo.kib.odc_demo.model.DataPacket(
            packetType = npo.kib.odc_demo.model.serialization.serializable.data_packet.DataPacketType.USER_INFO,
        ...
        val resultUserInfo = resultPacket.bytes.deserializeToDataPacketType<npo.kib.odc_demo.model.serialization.serializable.data_packet.variants.UserInfo>().printObj()
