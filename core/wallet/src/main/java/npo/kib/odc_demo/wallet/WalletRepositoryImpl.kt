...
import npo.kib.odc_demo.database.BanknotesDao
import npo.kib.odc_demo.database.BlockDao
...
class WalletRepositoryImpl(
    private val banknotesDao: npo.kib.odc_demo.database.BanknotesDao,
    private val blockDao: npo.kib.odc_demo.database.BlockDao,
...
) : npo.kib.odc_demo.domain.WalletRepository {
    ...
    override suspend fun getLocalUserInfo(): UserInfo = withContext(ioDispatcher) {
        UserInfo(
            defaultDataStoreRepository.readValueOrDefault(npo.kib.odc_demo.datastore.DefaultDataStoreObject.USER_NAME),
    ...
    override suspend fun getBanknotesIdsAndAmounts(): List<npo.kib.odc_demo.database.Amount> =
