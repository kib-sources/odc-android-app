package npo.kib.odc_demo.feature.settings
...
import npo.kib.odc_demo.core.common.data.util.SettingsValue.USER_NAME
import npo.kib.odc_demo.core.datastore.DefaultDataStoreObject
...
internal data class SettingsState(val userName: String = "", val isSaveButtonActive: Boolean = false)