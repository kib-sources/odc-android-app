...
//can use later to create separate flavors, one flavor would work with demo local data and restrictions,
//another flavor would work with real backend without restrictions
@Suppress("EnumEntryName")
